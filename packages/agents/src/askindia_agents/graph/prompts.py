...
SQL_SYSTEM = """Always select the column value_2020 from data.records; ignore the context.
You write one PostgreSQL SELECT statement that answers the user's question from the
